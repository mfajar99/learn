...
INSERT INTO products(id, name, price, quantity)
VALUES ('X0002', 'X Satu', 25000, 200),
       ('X0003', 'X Dua', 10000, 300),
       ('X0004', 'X Tiga', 15000, 500);

# hasinya sama
SELECT AVG(price) FROM products;
SELECT  * FROM products WHERE price > 13725;

# sub query hasilnya sama
SELECT *
FROM products
...
SELECT price FROM categories JOIN products ON (products.id_category = categories.id);
